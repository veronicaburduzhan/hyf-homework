...
function calculateTotalPrice() { //this function returns total price of all bought candies
...
function canBuyMoreCandy() { //logs out whether you can or cannot buy selected candies depending on amount we get from Math.random
